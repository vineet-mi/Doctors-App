...
const PageNotFound = () => {
  return (
    <div>
      <main class="grid min-h-screen place-items-center bg-base-200 px-6 py-24 sm:py-32 lg:px-8">
        <div class="text-center">
          <p class="text-base font-semibold text-blue-600">404</p>
          <h1 class="mt-4 text-3xl font-bold tracking-tight text-base sm:text-5xl">
            Page not found
          </h1>
          ...
          <div class="mt-10 flex items-center justify-center gap-x-6">
            ...
            <a href="#" class="text-sm font-semibold text-neutral">
