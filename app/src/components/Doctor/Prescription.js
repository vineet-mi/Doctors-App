...
const Prescription = ({ selectedPatient }) => {
  ...
  return (
    <div className="prescription bg-white p-4 rounded-md shadow-md xl:h-[calc(100vh-28vh)]">
      <div className="prescription-header mb-4 flex justify-between">
        <div>
          <h2 className="text-lg font-semibold text-left">Fortis Hospital</h2>
          <p className="text-sm">Airport Road, Sanaganer -302021</p>
        </div>
        <div>
          <h1 className="text-lg font-semibold text-right">Dr. Akash Mishra</h1>
